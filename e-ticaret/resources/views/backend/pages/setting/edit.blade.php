            ...
            <div class="card-body">
                ...
                <form action="{{$routelink}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{$setting->name ?? ''}}" placeholder="Key Başlık">
                    </div>
                    <div class="form-group">
                        <label for="data">Value</label>
                        <div class="inputContent">
                            @if (isset($setting->set_type) && $setting->set_type == 'ckeditor')
                            <textarea class="form-control" name="data" id="editor" placeholder="Data" rows="3">{{!! $setting->data ?? '' !!}}</textarea>
                            @elseif (isset($setting->set_type) && $setting->set_type == 'textarea')
                            <textarea class="form-control" name="data" id="data" placeholder="Data" rows="3">{{!! $setting->data ?? '' !!}}</textarea>
...
<script>
    ...
    function createInput(type){
        var defualtText = '{!! isset($setting->data) && $setting->data ? $setting->data : '' !!}';
