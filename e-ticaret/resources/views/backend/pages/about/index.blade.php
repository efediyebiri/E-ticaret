              ...
              <div class="card-body">
                ...
                <form action="{{route('panel.about.update')}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="text_1_content" name="text_1_content" placeholder="Text 1 Content" rows="3">{!! $about->text_1_content ?? '' !!}</textarea>
                  </div>
                  <div class="form-group">
