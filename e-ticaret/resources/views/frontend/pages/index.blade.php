        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                <a class="block-2-item" href="{{url($category->slug)}}">
                  <figure class="image">
                    <img src="{{asset($category->image)}}" alt="" class="img-fluid" style="height: 480px">
                  </figure>
                  <div class="text">
                    <h3>{{$category->name}}</h3>
                  </div>
                ...
                <div class="item">
                    <div class="block-4 text-center">
                      <figure class="block-4-image">
                        <a href="{{route('urundetay', $item->slug)}}"><img src="{{asset($item->image)}}" alt="Image placeholder" class="img-fluid" style="height: 400px"></a>
                      </figure>
