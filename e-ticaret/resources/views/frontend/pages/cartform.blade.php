                            ...
                            <div class="p-3 p-lg-5 border">
                                <table class="table site-block-order-table mb-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-black font-weight-bold"><strong>Kdv</strong></td>
                                            <td class="text-black font-weight-bold"><strong>% {{$cart['kdv'] ?? 0}}</strong></td>
                                        </tr>
                                ...
                                <form action="{{route('sepet.cartSave')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-lg py-3 btn-block">SATIN AL</button>
                                    </div>
                                </form>
                            </div>
                        </div>
