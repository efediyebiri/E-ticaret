...
Route::group(['middleware' => 'sitesetting'], function(){
    ...
    Route::get('/indirimdekiurunler', [PageController::class, "indirimdekiurunler"])->name("indirimdekiurunler");
    ...
    Route::post('/login_complate', [LoginController::class , 'authenticate'])->name('login_complate');
